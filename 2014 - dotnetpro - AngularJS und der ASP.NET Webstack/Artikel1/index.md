...
##### Fazit
 In der Praxis wird die AMD-Unterstützung sich garantiert mehrfach auszeichnen, denn die Software kann sich nun aus dem großen Fundus an bestehenden AMD-kompatiblen Bibliotheken bedienen. Die Verwendung von zwei Modul-Welten ist zudem leicht mit ein paar wenigen Code-Zeilen umsetzbar. Für die zukünftige Version 2 von AngularJS können wir übrigens auf eine direktere Unterstützung von modularem Laden dank ES6-Modulen (ECMAScript 6) gepannt sein [5]. Dank require.js und AMD müssen nicht lange auf die die zukünftige Entwicklung warten!  Bereits in nächsten Ausgabe wird das AMD-kompatible Ajax-Framework Breeze.js eingesetzt um Daten per OData zu laden. In der dritten Ausgabe erfahren Sie, wie Sie Ihre AngularJS-Anwendung mit Unit Tests absichern.
